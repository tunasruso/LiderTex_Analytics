...
CATEGORY_MAPPING = {
    ...
    'china': {  # Китайские перчатки
        ...
        'productcat_ids': [
            '5502e046-af74-daca-00cc-67f7c90060d0', # Parent
            '60921814-9eb8-6525-0fd8-6853b97872d3', # Nylon
            '40b921e6-eb6d-5a7a-444e-6853b988476b', # Nitrile
            'f6780968-41a6-a083-3fb8-6853b94e405c', # Split
        ],
        'count': 32
    },
}
